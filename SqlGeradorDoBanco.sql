...
ALTER DATABASE futpagode DEFAULT COLLATE utf8mb4_unicode_ci;
SET collation_connection = @@collation_database;

DROP PROCEDURE IF EXISTS InscreverOuDesinscreverJogadorEmJogo;
...
BEGIN
  IF EXISTS(SELECT * FROM participacao_em_jogo 
    WHERE participacao_em_jogo.Jogador_CPF = Jogador_CPF and participacao_em_jogo.Jogo_id = Jogo_id) 
    THEN
