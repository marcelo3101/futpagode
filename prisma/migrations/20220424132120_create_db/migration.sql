...
CREATE TABLE `Torneio` (
    ...
    `Ranking_minimo` INTEGER NOT NULL,
    `Ranking_maximo` INTEGER NOT NULL,
    `Time_vencedor` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Reserva` ADD CONSTRAINT `fk_Reserva_Campo1` FOREIGN KEY (`Campo_id`) REFERENCES `Campo`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `Reserva` ADD CONSTRAINT `fk_Reserva_Jogador1` FOREIGN KEY (`reservador_CPF`) REFERENCES `Jogador`(`CPF`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `participacao_em_jogo` ADD CONSTRAINT `fk_Jogador_has_Jogo_Jogador1` FOREIGN KEY (`Jogador_CPF`) REFERENCES `Jogador`(`CPF`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `participacao_em_jogo` ADD CONSTRAINT `fk_Jogador_has_Jogo_Jogo1` FOREIGN KEY (`Jogo_id`) REFERENCES `Jogo`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
